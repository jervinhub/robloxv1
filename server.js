...
app.get('/api/limited-items', async (req, res) => {
  try {
    res.json([
      {id:128739664413207,name:'Fractured Domino Crown',robux:'24,000',oldRobux:'22,500',bonus:'+1500 more',price:'₱11.49K',imageUrl:'https://thumbnails.roblox.com/v1/assets?assetIds=128739664413207'},
      {id:140223484513447,name:'Wings of the Pactbreaker',robux:'11,000',oldRobux:'10,000',bonus:'+1000 more',price:'₱5,700',imageUrl:'https://thumbnails.roblox.com/v1/assets?assetIds=140223484513447'}
    ]);
